...
# Game loop for each game of Rock_Paper_Scissors
    while True:
        print("-------------------------------------------")
        print("\t\tMenu")
        print("-------------------------------------------")
...
def rpsls():
    ...
    # Game loop for each game of Rock_Paper_Scissors_Lizard_Spock
    while True:
        print("--------------------------------------------------------------")
        print("\t\tMenu")
        print("--------------------------------------------------------------")
...
if __name__ == "__main__":
    ...
    # Win-lose matrix for traditional version
    rps_table = [[-1, 1, 0], [1, -1, 2], [0, 2, -1]]

    # win-lose matrix for Big Bang version
    ...
    while True:
        print()
        print("Let's Play!")
        print("Which version of Rock_Paper_Scissors?")
        print("Enter 1 to play Rock_Paper_Scissors")
        print("Enter 2 to play Rock_Paper_Scissors_Lizard_Spock")
        ...
        # Play the traditional one
        if choice == 1:
            rps()

        # Play the Big Bang version
        elif choice == 2:
            rpsls()
